...
const SinglePost = () => {
  ...
  // const pp = "/images/";
  const pp = "https://node-api-fjb6.onrender.com/images/";
  ...
  useEffect(() => {
    const getPost = async () => {
      const { data } = await axios.get(
        "https://node-api-fjb6.onrender.com/api/v1/post/" + path
      );
  ...
  const handleDelete = () => {
    ...
    axios
      .delete(`https://node-api-fjb6.onrender.com/api/v1/post/${post._id}`, {
  ...
  const handleUpdate = () => {
    axios
      .put(`https://node-api-fjb6.onrender.com/api/v1/post/${post._id}`, {
