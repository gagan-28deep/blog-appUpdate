...
const Settings = () => {
  ...
  // const PF = "/images/";
  const PF = "https://node-api-fjb6.onrender.com/images/";
  ...
  const handleDelete = async (e) => {
    ...
    try {
      let res = await axios.delete(
        "https://node-api-fjb6.onrender.com/api/v1/user/" + user.user._id,
        {
    ...
    try {
      ...
      if (uploadFile) {
        try {
          ...
          axios.post("https://node-api-fjb6.onrender.com/api/v1/upload", data);
        ...
        <form className="settingsForm" onSubmit={(e) => handleSubmit(e)}>
          ...
          <div className="settingsPP">
            {uploadFile ? (
              ...
              <img src= "https://images.pexels.com/photos/4240504/pexels-photo-4240504.jpeg?auto=compress&cs=tinysrgb&w=1600" alt="" />
            )}
            {/* <img
